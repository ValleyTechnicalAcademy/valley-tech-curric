---
title: "DAY 5 - JavaScript Cont. + Weekly Project"
courseId:  "CFSG105"
cirriculum:
...
<img src="http://pngimg.com/uploads/chrome_logo/chrome_logo_PNG30.png" width="200px">
...
<script>
function myFunction() {
    // When you click the button, turn a div background to red
...
* Create an HTML Button and add an onclick.

* When the user clicks on the button, alert ('Welcome to my page!');
...
![](https://www.htmlgoodies.com/img/2010/06/HTML-Forms-From-Basics-to-Style-Layouts-Figure1.gif)
...
* JS at its core has the ability to access HTML elements in an HTML page
* Manipulate, adjust, alter.
...
* Add an HTML form onto the page.

* When the user clicks on the button, grab the value of whatever the user entered in on the form

---

# Inserting into other Text

* innerHTML!

```JavaScript
document.getElementById("favoriteIceCream").innerHTML = "Mint Chocolate Chip";
```
---

# Your Turn!

* Add functionality to the onclick button function that will put whatever the user typed in into a div on the page.
...
var zooAnimals = ['rhino', 'giraffe', 'gorilla', 'zebra'];
